...
<html lang="en">
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <!--            <form class="login-form" action="{{URL::route('account-sign-in')}}" method="post">
                            ...
                            <div class="create-account">
                                <p>
                                    Don't have an account yet ?&nbsp; <a href="{{ URL::route('account-create')}}" id="register-btn">
                                        Create an account </a>
                                </p>
                            </div>
                            {{Form::token()}}
            ...
            <form class="forget-form" action="{{URL::route('account-forgot-password')}}" method="post">
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="Email_Id"/>
                    </div>
                </div>
                <div class="form-actions">
