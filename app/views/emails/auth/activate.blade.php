...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Open Survey | Account Activation</title>
        <!--IMPORTANT: 
                                                        ...
                                                        <table class="six columns">
                                                            <tr>
                                                                <td class="vertical-middle">
                                                                    <a href="index.html">
                                                                        <img src="{{URL:: asset('assets/admin/layout/img/logo.png') }}" width="86" height="14" border="0" alt=""/>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td>
                                                                    <table class="wrapper social-icons" align="right">
                                                                        <tr>
                                                                            <td class="vertical-middle">
                                                                                <a href="#">
                                                                                    <img src="{{URL:: asset('assets/admin/pages/media/email/social_facebook.png') }}" alt="social icon"/>
                                                                                </a>
                                                                            </td>
                                                                            <td class="vertical-middle">
                                                                                <a href="#">
                                                                                    <img src="{{URL:: asset('assets/admin/pages/media/email/social_twitter.png') }}" alt="social icon"/>
                                                                                </a>
                                                                            </td>
                                                                            <td class="vertical-middle">
                                                                                <a href="#">
                                                                                    <img src="{{URL:: asset('assets/admin/pages/media/email/social_googleplus.png') }}" alt="social icon"/>
                                                                                </a>
                                                                            </td>
                                                                            <td class="vertical-middle">
                                                                                <a href="#">
                                                                                    <img src="{{URL:: asset('assets/admin/pages/media/email/social_linkedin.png') }}" alt="social icon"/>
                                                                                </a>
                                                                            </td>
                                                                            <td class="vertical-middle">
                                                                                <a href="#">
                                                                                    <img src="{{URL:: asset('assets/admin/pages/media/email/social_rss.png') }}" alt="social icon"/>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img src="{{URL:: asset('assets/admin/pages/media/email/article.png') }}" class="ie10-responsive" alt=""/>
                                                    </td>
                                                    <td class="expander">
                                                    </td>
                                                </tr>
